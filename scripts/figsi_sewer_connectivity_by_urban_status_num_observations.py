...
plt.tight_layout()
plt.savefig('../figures/figsi_sewer_connectivity_by_urban_status_num_observations.png', dpi = 300)
plt.savefig('../figures/figsi_sewer_connectivity_by_urban_status_num_observations.pdf', dpi = 300)