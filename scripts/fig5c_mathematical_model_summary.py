...
parameter_set = {'Na':N, 'Nb':N, 'gammaI':gammaI, 'R0a':R0, 'R0b':R0}
...
plt.tight_layout()
plt.savefig('../figures/fig5c_mathematical_model_summary.png', dpi = 300)
plt.savefig('../figures/fig5c_mathematical_model_summary.png')